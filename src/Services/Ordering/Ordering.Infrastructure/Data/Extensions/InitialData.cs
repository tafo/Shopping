...
internal class InitialData
{
    public static IEnumerable<Customer> Customers =>
        new List<Customer>
        {
            Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "tayfun", "tayfun@gmail.com"),
    ...
    public static IEnumerable<Product> Products =>
        new List<Product>
        {
            ...
            Product.Create(ProductId.Of(new Guid("4f136e9f-ff8c-4c1f-9a33-d12f689bdab8")), "Huawei Plus", 350),
            Product.Create(ProductId.Of(new Guid("6ec1297b-ec0a-4aa1-be25-6726e3b51a27")), "Xiaomi Mi", 450)
        };

    // Complete the order with items initial data
    public static IEnumerable<Order> OrdersWithItems
    {
        get
        {
            var address1 = Address.Of("Tayfun", "Yirdem", "tayfun@gmail.com", "Corlu", "Turkey", "Tekirdag", "59850");
            var address2 = Address.Of("john", "doe", "john@gmail.com", "Broadway", "England", "Nottingham", "08050");

            var payment1 = Payment.Of("tayfun", "5555555555554444", "12/28", "355", 1);
